...
Nova.booting(function (Vue, router, store) {
  Vue.component('infoclient', __webpack_require__(2));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        //        console.log(this);
        console.log(this.card.currentClient);
    }
});
    ...
    [
      _c("div", { staticClass: "px-3 py-3" }, [
        _c("h1", { staticClass: "text-center text-3xl text-80 font-light" }, [
          _vm._v("Info Client - Cool Man!")
        ]),
        _vm._v(" "),
        _c("h2", [_vm._v("Client: " + _vm._s(this.card.currentClient))])
      ])
    ]
  )
}
