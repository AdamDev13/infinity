...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                this.fields = [];
                                _context.next = 3;
                                return Nova.request().get('/nova-vendor/ugduck/myprofile');
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 4:
                                ...
                                this.loading = false;
                                this.$toasted.show(this.__('Your profile has been saved!'), { type: 'success' }).goAway(2500);
        ...
        createRequest: function createRequest() {
            return Nova.request().post('/nova-vendor/ugduck/myprofile', this.createResourceFormData());
        },
  ...
  return _c(
    ...
    [
      _c("heading", { staticClass: "mb-3" }, [
        _vm._v(_vm._s(_vm.__("Update Your Profile")))
      ]),
      _vm._v(" "),
