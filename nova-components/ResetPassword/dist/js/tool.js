...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_laravel_nova__ = __webpack_require__(8);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                this.fields = [];
                                _context.next = 3;
                                return Nova.request().get('/nova-vendor/ugduck/reset-password');
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 4:
                                ...
                                this.__(response.data.message), { type: 'success' }).goAway(2500);
                            ...
                            case 10:
                                ...
                                if (_context2.t0.response.status == 422) {
                                    this.$toasted.show(this.__(_context2.t0.response.data.message), { type: 'error' }).goAway(2500);
                                    /*
        ...
        createRequest: function createRequest() {
            return Nova.request().post('/nova-vendor/ugduck/reset-password', this.createResourceFormData());
        },
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _c(
        "p",
        { staticStyle: { "margin-bottom": "5px", color: "rgba(255,0,0,.7)" } },
        [
          _vm._v(
            "*New password must include 8 characters, including 1 number & 1 special character."
          )
        ]
      ),
      _vm._v(" "),
