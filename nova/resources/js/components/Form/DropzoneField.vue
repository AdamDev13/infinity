    ...
    <template slot="field">
      ...
      >
        <vue-dropzone
          ...
          :id="idAttr"
          name="name"
          @vdropzone-success="dropzoneDone"
          :options="{
            ...
            maxFiles: 1,
            acceptedFiles: field.acceptedTypes
          }"
        >
        </vue-dropzone>
      </span>
...
export default {
  ...
  components: { DeleteButton, ImageLoader, VueDropzone: vue2Dropzone  },
  ...
  methods: {
    ...
    dropzoneDone(file, res) {
      this.fileName = file.name
      this.file = this.dataURLtoFile(res.files.file, file.name)
    },
    /**
