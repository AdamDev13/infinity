  ...
  <loading-view :loading="loading">
    ...
    >
      ...
      <div class="flex items-center">
        ...
        <progress-button
          dusk="update-button"
          @click.native="submitViaUpdateResourceAndSendEmail"
          :disabled="isWorking"
    ...
    <create-relation-modal
      v-if="sendingUpdateResourceEmail"
      @set-resource="submitViaUpdateResource"
      @cancelled-create="cancelSendEmail"
      resource-name="update-project-emails"
...
export default {
  ...
  data: () => ({
    ...
    sendingUpdateResourceEmail: false,
    title: null,
    fields: [],
    panels: [],
  ...
  methods: {
    ...
    async submitViaUpdateResource(e) {
      ...
      this.submittedViaUpdateResourceAndContinueEditing = false
      this.canLeave = true
      this.sendingUpdateResourceEmail = false
    ...
    submitViaUpdateResourceAndSendEmail() {
      if (this.resourceName === 'projects') {
        this.sendingUpdateResourceEmail = true
      } else {
        this.submitViaUpdateResource()
      }
    },
