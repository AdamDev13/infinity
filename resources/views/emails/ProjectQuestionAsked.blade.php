...
<head>
    ...
    <title>New Question on Project {{$project->name}} has Been  Submitted </title>
                        ...
                        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td style="padding:0 15px; text-align:center;">
                                    ...
                                    <p>New Question has been Submitted on {{$project->name}} by
                                        {{$projectQuestion->userBelongs->name}}</p>
                                    ...
                                    <table cellpadding="0" cellspacing="0"
                                        ...
                                        <tr>
                                            <td
                                                ...
                                                <strong>
                                                    {{$projectQuestion->userBelongs->name}}
                                                </strong>
                                            </td>
                                        </tr>
                                        </tbody>
